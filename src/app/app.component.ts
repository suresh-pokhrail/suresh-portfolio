...
export class AppComponent implements OnInit, OnDestroy{
  ...
  ngOnInit(): void{
    ...
    this.titleService.setTitle( "Suresh Pokhrail | Full Stack Developer" );

    this.metaService.addTags([
      {name: 'keywords', content: 'Full Stack Developer'},
      {name: 'description', content: 'A verstile Full Stack Developer having skill of complex problem solving.'},
    ]);
